...
namespace SMPP
{
    ...
    public class SMSC
    {
        ...
        public SMSC(string description, string host, int port, string systemId, string password, string systemType, int sequenceNumber, string smsFrom)
        {
        ...
        public SMSC(string description, string host, int port, string systemId, string password, string systemType, byte addrTon, byte addrNpi, string addressRange, int sequenceNumber, string smsFrom) : this(description ,host, port, systemId, password, systemType, sequenceNumber, smsFrom)
        {
